  ...
  return (
    <section className="relative overflow-hidden bg-background">
      ...
      <div className="grid min-h-[92vh] grid-rows-[1fr_auto] lg:grid-rows-none lg:grid-cols-[1fr_1fr]">
        ...
        {/* RIGHT — clinician photo (hidden on mobile, visible lg+) */}
        <div className="relative hidden lg:block">
          <Image
            src="/clinician-glasses.jpg"
            alt="Clinician wearing Aurion smart glasses during a patient encounter"
            fill
          ...
          <div
            className="absolute inset-0"
            style={{ background: "linear-gradient(to top, rgba(11,31,58,0.4) 0%, transparent 45%)" }}
          />

          {/* Live capture callout */}
          <div className="absolute bottom-10 right-8 w-[240px] border border-[#F5F4F0]/20 bg-[#0B1F3A]/82 px-5 py-4 backdrop-blur-sm">
            <p className="text-[9px] tracking-[0.25em] text-accent uppercase">Live capture</p>
            <p className="mt-1.5 font-serif text-[13px] leading-[1.5] text-[#F5F4F0]">
              Antalgic gait observed — ROM 110° flexion
            </p>
            <p className="mt-2 text-[10px] text-[#F5F4F0]/45">Auto-tagged · 00:04:32</p>
          </div>
        </div>
        ...
        <div className="relative h-64 w-full overflow-hidden sm:h-80 lg:hidden">
          <Image
            src="/clinician-glasses.jpg"
            alt="Clinician wearing Aurion smart glasses"
            fill
